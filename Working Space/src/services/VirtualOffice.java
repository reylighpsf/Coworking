...
public class VirtualOffice extends Room {
    public VirtualOffice(String customerName, String bookingDuration, List<String> selectedFacilities, String room, double totalPrice, boolean isMember) {
        super(customerName, bookingDuration, selectedFacilities, room, totalPrice, isMember);
    }

    private enum RoomType {
        BUSINESS_ADDRESS("Business Address", 200000), // price per month
        VIRTUAL_OFFICE("Virtual Office", 500000); // price per month
    ...
    private static void displayRoomOptions() {
        ...
        System.out.println("\t===============================================================");
        System.out.println("\t==   No  |   Room Type          | Price          ==");
        System.out.println("\t==-----------------------------------------------------------==");
        System.out.println("\t==   1   |  Business Address     | 200,000/month   ==");
        System.out.println("\t==   2   |  Virtual Office       | 500,000/month   ==");
        System.out.println("\t===============================================================");
    }
    ...
    // Method to handle virtual office order with membership type
    public static void virtualOfficeOrder(Scanner scanner, String membershipType) {
        ...
        switch (choice) {
            case 1 -> selectedRoomType = RoomType.BUSINESS_ADDRESS;
            case 2 -> selectedRoomType = RoomType.VIRTUAL_OFFICE;
            default -> {
    ...
    public static void virtualOfficeOrderWithoutMembership(Scanner scanner) {
        // Display room options
        displayRoomOptions();
