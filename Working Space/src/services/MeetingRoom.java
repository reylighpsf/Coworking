...
public class MeetingRoom extends Room {
    public MeetingRoom(String customerName, String bookingDuration, List<String> selectedFacilities, String room, double totalPrice, boolean isMember) {
        super(customerName, bookingDuration, selectedFacilities, room, totalPrice, isMember);
    }

    private enum RoomType {
        INTERVIEW_ROOM("Interview Room", 200000),
        TRAINING_ROOM("Training Room", 500000),
        BOARD_ROOM("Board Room", 7000000);
    ...
    private static void displayMeetingRooms() {
        System.out.println("\t===============================================================");
        System.out.println("\t==                       Room Options                        ==");
        System.out.println("\t===============================================================");
        System.out.println("\t==   No  |   Room Type          | Capacity  |   Time Period   ==");
        System.out.println("\t==-----------------------------------------------------------==");
        System.out.println("\t==   1   |  Interview Room      |    20     | month/year      ==");
        System.out.println("\t==   2   |  Training Room       |    30     | month/year      ==");
        System.out.println("\t==   3   |  Board Room          |    15     | price/hour      ==");
        System.out.println("\t===============================================================");
    }
    ...
    // Method to handle meeting room order with membership type
    public static void meetingRoomOrder(Scanner scanner, String membershipType) {
        ...
        switch (choice) {
            case 1 -> selectedRoomType = RoomType.INTERVIEW_ROOM;
            case 2 -> selectedRoomType = RoomType.TRAINING_ROOM;
            case 3 -> selectedRoomType = RoomType.BOARD_ROOM;
            default -> {
        ...
        Room booking = new MeetingRoom(customerName, durationInput, selectedFacilities, selectedRoomType.toString(), totalPrice, true); // Assuming it's a member booking
    ...
    public static void meetingRoomOrderWithoutMembership(Scanner scanner) {
        // Display room options
        displayMeetingRooms();
        ...
        // Create a new booking and add it to the list
        Room booking = new MeetingRoom(customerName, durationInput, selectedFacilities, selectedRoomType.toString(), totalPrice, false); // Assuming it's a non-member booking
        Room.bookings.add(booking); // Add booking to the list
