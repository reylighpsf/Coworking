...
public class CoworkingSpace extends Room {

    public CoworkingSpace(String customerName, String bookingDuration, List<String> selectedFacilities, String room, double totalPrice, boolean isMember) {
        super(customerName, bookingDuration, selectedFacilities, room, totalPrice, isMember);
    }

    private enum RoomType {
        DEDICATED_DESK("Dedicated Desk", 2000000),
        DAY_COWORKINGSPACE("Day Coworking Space", 1500000),
        COWORKING_MEMBERSHIP("Coworking Membership", 100000);
    ...
    private static void displayCoworkingSpace() {
        System.out.println("\t===============================================================");
        System.out.println("\t==                       Room Options                        ==");
        System.out.println("\t===============================================================");
        System.out.println("\t==   No  |   Room Type          | Capacity  | Price          ==");
        System.out.println("\t==-----------------------------------------------------------==");
        System.out.println("\t==   1   |  Dedicated Desk      |    20     | 2.000.000/month ==");
        System.out.println("\t==   2   |  Day Coworking Space |    30     | 1.500.000/month ==");
        System.out.println("\t==   3   | Coworking Membership |    15     | 100.000/hour   ==");
        System.out.println("\t===============================================================");
    }
    ...
    public static void coworkingOrder(Scanner scanner, String membershipType) {

        ClearScreen.clearScreen();

        displayCoworkingSpace();
        ...
        switch (choice) {
            case 1 -> selectedRoomType = RoomType.DEDICATED_DESK;
            case 2 -> selectedRoomType = RoomType.DAY_COWORKINGSPACE;
            case 3 -> selectedRoomType = RoomType.COWORKING_MEMBERSHIP;
            default -> {
        ...
        Room booking = new VirtualOffice(customerName, durationInput, selectedFacilities, selectedRoomType.toString(), totalPrice, true); // Assuming it's a member booking
    ...
    public static void coworkingOrderWithoutMembership(Scanner scanner) {
        ...
        // Create a new booking and add it to the list
        Room booking = new VirtualOffice(customerName, durationInput, selectedFacilities, selectedRoomType.toString(), totalPrice, false); // Assuming it's a non-member booking
        Room.bookings.add(booking); // Add booking to the list
